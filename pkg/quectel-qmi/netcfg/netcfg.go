...
// SetIPv6DelegatedPrefix 将运营商委派前缀(PD)写入接口 / SetIPv6DelegatedPrefix写入PD
func SetIPv6DelegatedPrefix(ifname string, prefix net.IP, prefixLen int) error {
	return GetConfigurator().SetIPv6DelegatedPrefix(ifname, prefix, prefixLen)
}
