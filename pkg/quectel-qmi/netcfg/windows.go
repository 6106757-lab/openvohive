...
// SetIPv6DelegatedPrefix 非 OpenWrt 平台无需写 ip6prefix (no-op)。
func (w *WindowsConfigurator) SetIPv6DelegatedPrefix(ifname string, prefix net.IP, prefixLen int) error {
	return nil
}
