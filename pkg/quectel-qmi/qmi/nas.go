...
// GetNR5GDuplexModeFromBandInfo 从 RF Band Info 获取 NR5G 双工模式
func GetNR5GDuplexModeFromBandInfo(info *RFBandInfo) string {
	if info == nil {
		return ""
	}
	for _, band := range info.Bands {
		if band.RadioInterface != 0x0C {
			continue
		}
		if duplex := getNR5GDuplexModeFromBand(band.ActiveBandClass); duplex != "" {
			return duplex
		}
	}
	return ""
...
// GetNR5GDuplexModeFromCellLocation 从 Cell Location Info 获取 NR5G 双工模式
func GetNR5GDuplexModeFromCellLocation(info *CellLocationInfo) string {
	if info == nil || !info.NR5G.HasARFCN {
		return ""
	}
	return getNR5GDuplexModeFromNRARFCN(info.NR5G.ARFCN)
}

func getNR5GDuplexModeFromBand(band uint16) string {
	// NR5G band: 1-255 -> n1-n255
	// TDD bands: n34, n38, n39, n40, n41, n48, n50, n51, n53, n77, n78, n79, n90, n96, n100, n101, n102, n104
	switch band {
	case 34, 38, 39, 40, 41, 48, 50, 51, 53, 77, 78, 79, 90, 96, 100, 101, 102, 104:
		return "TDD"
	default:
		return "FDD"
	}
...
func getNR5GDuplexModeFromNRARFCN(arfcn uint32) string {
	// NR-ARFCN 范围映射
	// n1 (FDD): 422000 - 434000
	// n28 (FDD): 151600 - 160600
	// n41 (TDD): 499200 - 537999
	// n77 (TDD): 620000 - 680000
	// n78 (TDD): 620000 - 653333
	// n79 (TDD): 693334 - 733333
	switch {
	...
	case arfcn >= 693334 && arfcn <= 733333:
		return "TDD" // n79
	case arfcn <= 3000000:
		return "FDD" // 大多数低 NR-ARFCN 是 FDD
	default:
		return ""
	}
}
